    ...
    <section>
                ...
                <article>
                    <div class="container">
                        <div class="four columns">
                            ...
                            <a class="button button-primary" href="#" title="Descarga nuestro brochure">Descarga<br>nuestro brochure</a>
                        </div>
                ...
                <article>
                        ...
                        <div class="container">
                            ...
                            <div class="six columns">
                                <div class="detalle-equipo"><!-- detalle-equipo -->
                                    <h2>Mauricio Herrera</h2>
                                    <h3>Ingeniero Civil en Geografía. Universidad de Santiago de Chile.</h3>
                                    <p>Gerente General</p>
                    ...
                    <div class="full-equipo"><!-- full-equipo -->
                        <div class="container">
                            <div class="twelve columns">
                                <ul>
                                    <li><a href="#" title="Catalina Rojas"><img src="<?php bloginfo('template_url') ?>/images/img-full-equipo.jpg" border="0" draggable="false" alt="Catalina Rojas" /></a></li>
                                    <li><a href="#" title="Catalina Rojas"><img src="<?php bloginfo('template_url') ?>/images/img-full-equipo.jpg" border="0" draggable="false" alt="Catalina Rojas" /></a></li>
                                    <li><a href="#" title="Catalina Rojas"><img src="<?php bloginfo('template_url') ?>/images/img-full-equipo.jpg" border="0" draggable="false" alt="Catalina Rojas" /></a></li>
                                    <li><a href="#" title="Catalina Rojas"><img src="<?php bloginfo('template_url') ?>/images/img-full-equipo.jpg" border="0" draggable="false" alt="Catalina Rojas" /></a></li>
                                    <li><a href="#" title="Catalina Rojas"><img src="<?php bloginfo('template_url') ?>/images/img-full-equipo.jpg" border="0" draggable="false" alt="Catalina Rojas" /></a></li>
        ...
        <div class="break">
            <div class="banner-clientes"><!-- banner-clientes -->
                <div class="cover"></div>
                <div class="container">
                    <div class="deco-clientes"><!-- deco-clientes -->
                        <a class="button button-primary" href="#" title="Nuestros Clientes">Nuestros<br>Clientes</a>
